...
import numpy as np
import math
from models.modules import CARB,CARBH,upsample_block,Nonlocal_CA,WavePool,WaveUnpool
...
class WaveBlock(nn.Module):
    def __init__(self):
        ...
        self.block1 = nn.Sequential(CARBH(64),ScaleLayer(init_value=1.0))
        self.block2 = nn.Sequential(CARBH(64),ScaleLayer(init_value=1.0))
        self.block3 = nn.Sequential(CARBH(64),ScaleLayer(init_value=1.0))
        self.block4 = nn.Sequential(CARBH(64),ScaleLayer(init_value=1.0))
