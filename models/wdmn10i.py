...
class Net(nn.Module):
    ...
    def forward(self, x):
        ...
        b1_res = pool.apply_async(func=self.branch1, args=(x1,))
        b2_res = pool.apply_async(func=self.branch2, args=(feat_down2,))
        b3_res = pool.apply_async(func=self.branch3, args=(feat_down4,))
        b4_res = pool.apply_async(func=self.branch4, args=(feat_down8,))
        # b1 = self.branch1(x1)
